---
title: "MI vs Sham RNA-seq Workflow — Reproducible Notebook"
...
# 1. Study Context & Design

- Briefly describe biological question (MI vs Sham; 1d vs 3d).
- Define hypotheses and expected contrasts.
- Include inclusion/exclusion criteria and QC plan.
...
- Save key tables as CSV (DE results, HVGs).
- Save figures as PNG/SVG.
- Record session info.
...
Cite key tools and methods (Ensembl/biomaRt, tximport, DESeq2, fgsea, t-SNE/UMAP, etc.). Add them to `references.bib` and set an appropriate CSL file.
